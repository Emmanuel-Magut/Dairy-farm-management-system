<!-- this is the page for the dairy farmer to deete insemination -->
<?php
session_start(); //#1
...
<html>
<head>
	<title>Delete Insemination</title>
     ...
     <div class="mask">
      <div class="d-flex justify-content-center align-items-center h-100">
        <div class="text-white">
          <h1 class="mb-3">Delete Insemination</h1>
          </div>
      </div>
    </div>
    </div>
...
// Check for a valid insemination ID, through GET or POST
...
if ( (isset($_POST['id'])) && (is_numeric($_POST['id'])) ) {
 ...
 // Make the query:
 // prepare statement to remove security problems
 $q = mysqli_stmt_init($dbcon);
 mysqli_stmt_prepare($q, 'DELETE FROM insemination WHERE insemination_id=? LIMIT 1');
 ...
 $q = mysqli_stmt_init($dbcon);
 $query = "SELECT date_inseminated FROM insemination WHERE insemination_id=?";
...
<form action="delete_insemination.php" method="post"
