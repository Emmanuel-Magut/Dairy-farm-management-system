<!-- this is page is for deleting milk production record-->
<?php
session_start(); //#1
     ...
     <div class="mask">
      <div class="d-flex justify-content-center align-items-center h-100">
        <div class="text-white">
          <h1 class="mb-3">Delete Production:</h1>
          </div>
      </div>
    </div>
    </div>
...
// Check for a valid production ID, through GET or POST
...
if ( (isset($_POST['id'])) && (is_numeric($_POST['id'])) ) {
 ...
 mysqli_stmt_prepare($q, 'DELETE FROM milk_production WHERE production_id=? LIMIT 1');
 ...
 $q = mysqli_stmt_init($dbcon);
 $query = "SELECT litres_produced FROM milk_production WHERE production_id=?";
