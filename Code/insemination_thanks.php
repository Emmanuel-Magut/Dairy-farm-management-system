<!-- page that shows the farmer that insemination was successful-->
<!DOCTYPE html>
<html lang="en">
<head>
 <title>Insemination Registered</title>
 <meta charset="utf-8">
     ...
     <div class="mask">
      <div class="d-flex justify-content-center align-items-center h-100">
        <div class="text-white">
          <h1 class="mb-3">New Insemination Registered</h1>
          </div>
      </div>
    </div>
    </div>
...
<div class="alert alert-success">
    <strong>Success!</strong><br>Insemination Has Been Registered Successfully. 
</div> 
  </div>
