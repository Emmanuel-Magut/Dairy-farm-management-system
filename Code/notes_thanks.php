<!-- page for showing that the personal journal has been added to the database successfully-->
<!DOCTYPE html>
<html lang="en">
<head>
     ...
     <div class="mask">
      <div class="d-flex justify-content-center align-items-center h-100">
        <div class="text-white">
          <h1 class="mb-3">New Note Added</h1>
          </div>
      </div>
    </div>
    </div>
...
<div class="alert alert-success">
    <!--  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a> -->
  	 <strong>Success!</strong><br>New Note Has Been Added Successfully. 
</div> 
  </div>
