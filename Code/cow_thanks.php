<!-- This is a page that shows the dairy farmer that he has registered a new cow successfully -->
<!DOCTYPE html>
<html lang="en">
<head>
     ...
     <div class="mask">
      <div class="d-flex justify-content-center align-items-center h-100">
        <div class="text-white">
          <h1 class="mb-3">New Cow Registered</h1>
          </div>
      </div>
    </div>
    </div>
...
<div class="alert alert-success">
    <!--  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a> -->
  	 <strong>Success!</strong><br>New Cow Has Been Registered Successfully. 
</div> 
  </div>
