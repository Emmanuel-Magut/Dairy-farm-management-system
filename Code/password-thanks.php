<!-- page that notifies the user that the password has been change successfully-->
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="mask">
 ...
 onclick="location.href = 'login_page.php'" >Home</button>
</div>
 </nav>
</header>
...
<div class="alert alert-success">
  <strong>Success!</strong><br>You password Has Been Changed. You will Now Be Able To Login With Your New Password. 
</div> 
  </div>
