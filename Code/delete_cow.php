<!-- This is a page for deleting a cow -->
<?php
session_start(); //session ensures only farm admin with user leve 2 can delete the cow from database
...
// Check for a valid cow ID, through GET or POST
...
if ( (isset($_POST['id'])) && (is_numeric($_POST['id'])) ) {
 ...
 mysqli_stmt_prepare($q, 'DELETE FROM cows WHERE cow_id=? LIMIT 1');
 ...
 $q = mysqli_stmt_init($dbcon);
 $query = "SELECT serial_no_name FROM cows WHERE cow_id=?";
...
<form action="delete_cow.php" method="post"
